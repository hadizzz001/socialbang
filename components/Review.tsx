                            ...
                            <center>
                                <article className='container' style={{ maxWidth: "500px" }}>
                                    <div className="flex items-center mb-4" style={{ display: "inline" }}>
                                        <img className="w-20 h-20 rounded-full" src="https://www.svgrepo.com/show/527946/user-circle.svg" alt="User" />
                                    ...
                                    {Array.from({ length: post.stars }, (_, index) => (
                                        <div key={index} className="flex items-center mb-1 space-x-1 rtl:space-x-reverse" style={{ display: "inline-flex" }}>
